...
import LabelPrinter from "@/components/label/LabelPrinter"
    ...
    <div className="flex">
      ...
      <div className="min-h-screen w-64 bg-gray-800 p-4 text-white">
        ...
        <nav>
          <ul className="space-y-4">
            <li>
              <button
                className={`block rounded p-2 text-lg ${activeSection === "allergens" ? "bg-gray-600" : ""}`}
            ...
            <li>
              <button
                className={`block rounded p-2 text-lg ${activeSection === "categories" ? "bg-gray-600" : ""}`}
            ...
            <li>
              <button
                className={`block rounded p-2 text-lg ${activeSection === "menu-item-categories" ? "bg-gray-600" : ""}`}
            ...
            <li>
              <button
                className={`block rounded p-2 text-lg ${activeSection === "ingredients" ? "bg-gray-600" : ""}`}
            ...
            <li>
              <button
                className={`block rounded p-2 text-lg ${activeSection === "menu-items" ? "bg-gray-600" : ""}`}
            ...
            <li>
              <button
                className={`block rounded p-2 text-lg ${activeSection === "subscription" ? "bg-gray-600" : ""}`}
      ...
      <div className="flex-1 p-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">Manage your allergens and check ingredients</p>
        </div>

        {/* Render Content Based on Active Section */}
        {activeSection === "labels" && <LabelPrinter />}
